...
const HostelCheckinPage = () => {
    ...
    // use effect fetching students checkins
    useEffect(() => {
    ...
    const search = (value) => {
        if (value) {
            ...
            const filterd_checkins = allCheckin.filter(checkin => checkin.student_name.toLowerCase().includes(lowercase_value) || checkin.mobile_no.toLowerCase().includes(lowercase_value));
