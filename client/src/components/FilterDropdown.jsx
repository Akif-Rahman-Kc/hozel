...
const FilterDropdown = ({ key_name, items, selectedValue, setSelectedValue }) => {
    ...
    return (
        <div>
            ...
            <select className="w-full text-xs text-black font-bold bg-gray-200 capitalize p-2 rounded-md border border-gray-800" name={key_name} id={key_name} value={selectedValue} onChange={handleChange}>
